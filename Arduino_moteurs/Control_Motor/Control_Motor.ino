...
void loop() {
  ...
  driver.writeMicroseconds(3, angleToPulse(135 + compensationArrayMec[3] + 0));
  driver.writeMicroseconds(5, angleToPulse(135 + compensationArrayMec[5] + 45));
  driver.writeMicroseconds(4, angleToPulse(135 + compensationArrayMec[4] + 45));
  

  driver.writeMicroseconds(9, angleToPulse(135 + compensationArrayMec[9] + 0));
  driver.writeMicroseconds(10, angleToPulse(135 + compensationArrayMec[10] + 0));
  driver.writeMicroseconds(11, angleToPulse(135 + compensationArrayMec[11] - 135));
  
  /*driver.writeMicroseconds(6, angleToPulse(135 + compensationArrayMec[6] + 0));
  driver.writeMicroseconds(7, angleToPulse(135 + compensationArrayMec[7] + 0));
  driver.writeMicroseconds(8, angleToPulse(135 + compensationArrayMec[8] + 135));
  driver.writeMicroseconds(1, angleToPulse(135 + compensationArrayMec[1] - 45));
  driver.writeMicroseconds(2, angleToPulse(135 + compensationArrayMec[2] + 0));*/
