...
import numpy as np
from . import motor
from include.spotmini_kinematics.util import pybullet_data
...
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[0]] = [-0.401, 0.785]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[1]] = [-1.571, 1.920]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[2]] = [-1.396, 1.745]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[3]] = [-0.785, 0.401]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[4]] = [-1.920, 1.571]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[5]] = [-1.745, 1.396]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[6]] = [-0.401, 0.785]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[7]] = [-1.571, 1.920]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[8]] = [-1.396, 1.745]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[9]] = [-0.785, 0.401]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[10]] = [-1.920, 1.571]
MOTOR_LIMITS_BY_NAME[MOTOR_NAMES[11]] = [-1.745, 1.396]
        ...
        if reload_urdf:
            if self._self_collision_enabled:
                self.quadruped = self._pybullet_client.loadURDF(
                    pybullet_data.getDataPath() + "/../../../../../qd_simulation/robot_description/quadrus.urdf",
                    init_position,
